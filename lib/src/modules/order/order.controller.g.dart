...
mixin _$OrderController on OrderControllerBase, Store {
  ...
  late final _$changeStatusFilterAsyncAction =
      AsyncAction('OrderControllerBase.changeStatusFilter', context: context);

  @override
  Future<void> changeStatusFilter(OrderStatus? status) {
    return _$changeStatusFilterAsyncAction
        .run(() => super.changeStatusFilter(status));
  }
